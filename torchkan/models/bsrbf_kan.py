""" https://github.com/hoangthangta/BSRBF_KAN/blob/main/models/bsrbf_kan.py """
import math
import numpy as np
import torch
...
class BSRBF_KAN(torch.nn.Module):
    """ Kolmogorov Arnold Network (KAN) that combines Bsplines (BS) and radial basis functions (RBFs) """
    def __init__(
        self, 
        layers_hidden,
        grid_size=5,
